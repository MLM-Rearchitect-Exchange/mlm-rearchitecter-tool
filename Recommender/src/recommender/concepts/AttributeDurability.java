...
public class AttributeDurability implements Concept {
	...
	public int appearances(Resource multilevelResource) {
		...
		while (eObjectsIt.hasNext()) {
			...
			if (eo.eClass().equals(common.Constants.potencyEC) && ec.eClass().equals(common.Constants.attributeEC)) {
